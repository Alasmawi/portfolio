...
export const TRACES = [
  ...
  },
  {
    ...
    result: 'Each obligation moves to due soon, then critical, as its renewal date approaches.',
    spans: [
      ...
      { name: 'Renewal check', detail: 'due soon → critical', start: 0.52, width: 0.22 },
